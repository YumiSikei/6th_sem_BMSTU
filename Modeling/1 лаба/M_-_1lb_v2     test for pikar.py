...
def fun_1__4(x):
    return ((x*x)/2)+((x**3)/6)+((x**4)/24) + (x**5)/120

def fun_1__11(x):
    return (((x*x)/2)+((x**3)/6)+((x**4)/24) + (x**5)/120 + (x**6)/720 + (x**7)/5040 + (x**8)/ 40320
            + (x**9)/362880 + (x**10)/3628800 + (x**11)/39916800 + (x**12)/479001600)

def fun_2(x):
    return (((x**3)/3)+((x**7)/63)+(2*(x**11)/2079)+((x**15)/59535))**2

def fun_2__4(x):
    return ((x**3)/3 + (x**7)/63 + (x**15)/59535 + 4*(x**23)/99411543 + (x**31)/1845585
            + (2 * x**11)/2079 + (4 * x**15)/93555 + (2 * x**19)/3393495
            + (4 * x**19)/2488563 + (x**23)/86266215 + (4 * x**27)/3341878155)**2
    '''
...
def met_pkr(h, P1, P2):
    ...
    while x <= 10:
        #yi = intgrl_1(x)[0]
        y = integrate.quad(fun_1__4, 0, x)[0]
        P1.append( (h**2)/2 + y)
        #yi = intgrl_2(x)[0]
        y = integrate.quad(fun_2__4, 0, x)[0]
        P2.append( (h**3)/3 + y)
        i += 1
        x += h
...
while x <= 10:
    ...
    print('{:3.3f}  |{:10.3f}  | {:10.3f}  | {:10.3f}  |{:10.3f}'.format(x,E1[i],EN1[i],RK1[i],P1[i]))
    x += H
    xo += H
    i += 1
...
while x <= 10:
    #if (int(x) != int(xo)) or x == 0:
    print('{:3.3f}  |{:10.3e}  | {:10.3e}  | {:10.3e}  |{:10.3e}'.format(x,E2[i],EN2[i],RK2[i],P2[i]))
    x += H
    xo += H
    i += 1
