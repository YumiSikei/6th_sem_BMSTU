...
#метод Пикара
def met_pkr(h, P1_1, P1_2, P1_3, P1_4, P2_1, P2_2, P2_3, P2_4):
    x = 0
    i = 0
    while x <= 10:
        yi = intgrl_1(x)[0]
        ...
        y = integrate.quad(fun_1__1, 0, x)[0]
        P1_2.append(y + yi)

        y = integrate.quad(fun_1__2, 0, x)[0]
        P1_3.append(y + yi)

        y = integrate.quad(fun_1__3, 0, x)[0]
        P1_4.append(y + yi)
        ...
        y = integrate.quad(fun_2__1, 0, x)[0]
        P2_2.append(y + yi)

        y = integrate.quad(fun_2__2, 0, x)[0]
        P2_3.append(y + yi)

        y = integrate.quad(fun_2__3, 0, x)[0]
        P2_4.append(y + yi)
...
P2_3 = []
P2_4 = []
met_pkr(H, P1_1, P1_2, P1_3, P1_4, P2_1, P2_2, P2_3, P2_4)

print('h = ', H)
print("u'(x) = x + u")
print('x     pik 1          pik 2            pik 3            pik 4')
x = 0
xo = 0 - H
i = 0
while x <= 4:
    ...
    print('{:3.3f}  |{:10.3f}  | {:10.3f}  | {:10.3f}  |{:10.3f}'.format(x,P1_1[i],P1_2[i],P1_3[i],P1_4[i]))
    x += H
    xo += H
    i += 1
...
while x <= 4:
    #if (int(x) != int(xo)) or x == 0:
    print('{:3.3f}  |{:10.3e}  | {:10.3e}  | {:10.3e}  |{:10.3e}'.format(x,P2_1[i],P2_2[i],P2_3[i],P2_4[i]))
    x += H
    xo += H
    i += 1
